...
| `admin/index.html` | Beheer, achter een client-side inlog (tab Beheerders beheert de accounts, elk account heeft een rol: beheerder of blogger): evenementen CRUD + foto-upload, inschrijvingen bekijken/mailen/exporteren, WhatsApp-aanmeldingen, blogberichten (tab Blog) |
